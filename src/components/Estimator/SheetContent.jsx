...
export function LightningLaneSheet() {
  return (
    <>
      ...
      <div className={styles.siNote}><strong>Honest take:</strong> worth it for families with young kids who tire of long waits, or anyone visiting during summer/holiday crowd levels. If you're traveling value season with a party willing to rope-drop and use standby strategically, you can often skip it. Singles are usually only worth it for 1–2 must-do headliners rather than buying them for every ride.</div>
    </>
  )
}
