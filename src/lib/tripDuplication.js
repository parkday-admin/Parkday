...
export async function copyWishListItems(userId, sourceTripId, newTripId) {
  ...
  const rows = items.map(({ catalog_id, name, park, category, price_label, price_mid, notes, custom }) => ({
    user_id: userId, trip_id: newTripId, catalog_id, name, park, category, price_label, price_mid, notes, custom,
