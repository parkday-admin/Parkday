...
export async function copyWishListItems(userId, sourceTripId, newTripId) {
  ...
  const rows = items.map(({ catalog_id, name, park, category, price_label, price_mid, notes, custom, lightning_lane_tier, dining_tier, cuisine, dining_plan_credits, seasonal, tags, location_detail, item_type, booth_id }) => ({
    user_id: userId, trip_id: newTripId, catalog_id, name, park, category, price_label, price_mid, notes, custom, lightning_lane_tier, dining_tier, cuisine, dining_plan_credits, seasonal, tags, location_detail, item_type, booth_id,
