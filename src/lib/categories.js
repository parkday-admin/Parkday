export const CATEGORY_META = {
  ...
  dining:     { label: 'Dining',          icon: 'ti-tools-kitchen-2',  color: 'var(--sky-dark)',  bg: 'rgba(42,111,224,0.1)', prog: 'var(--sky)',       scope: 'day' },
  snacks:     { label: 'Snacks',          icon: 'ti-ice-cream',        color: 'var(--gold-dark)', bg: 'rgba(245,181,54,0.15)',prog: 'var(--gold)',      scope: 'day' },
  ...
  souvenirs:  { label: 'Souvenirs',       icon: 'ti-gift',             color: 'var(--night)',     bg: 'rgba(13,35,64,0.1)',   prog: 'var(--night)',     scope: 'day' },
